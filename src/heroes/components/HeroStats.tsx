...
export const HeroStats = () => {
    ...
    const getPercent = () => (favoriteCount/(summary?.totalHeroes??0)*100).toFixed(2);
        ...
        <>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                >
                    ...
                    <p className="text-xs text-muted-foreground" data-testid="favorite-percentage">{getPercent()}% of total</p>
                </HeroStatCard>
                <HeroStatCard 
                    title="Fuerte"
