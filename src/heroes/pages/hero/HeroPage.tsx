          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="relative">
              <img
                ...
                width={200}
                height={200}
                className="rounded-full border-4 border-white/20 shadow-2xl object-cover aspect-square"
              />
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                ...
                <Badge className={`${getStatusColor(superheroData.status.toLowerCase())} text-white`}>{superheroData.status}</Badge>
